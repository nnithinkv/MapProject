...
import { Animated as RNAnimated, Animated, NativeSyntheticEvent, View, ViewProps } from 'react-native';
...
declare type NativeProps = Omit<ModifiedProps, 'customMapStyle' | 'onRegionChange' | 'onRegionChangeComplete'> & {
...
declare type SnapShot = Region | null;
declare class MapView extends React.Component<MapViewProps, State, SnapShot> {
    static Animated: Animated.AnimatedComponent<typeof MapView>;
    private map;
    private __lastRegion;
    private __layoutCalled;
    constructor(props: MapViewProps);
    setNativeProps(props: Partial<NativeProps>): void;
    getSnapshotBeforeUpdate(prevProps: MapViewProps): Region | null;
    componentDidUpdate(_prevProps: MapViewProps, _prevState: State, region: SnapShot): void;
